public static class StringValuesEn
{
    ...
    public static string GAME_ASTEROIDS = "Asteroids: \n";

    public static string GAME_OVER = "Game over";
    public static string NEW_RECORD = "Congratulations, you broke your high score!";
    public static string RESTART = "Restart";

    // Player prefs string consts
    public static string PLAYER_PREFS_BEST_SCORE = "BestScore";
}
